...
For SAW_v6, please use the [stereoPipeline_v6.1.0.sh](https://github.com/BGIResearch/SAW/blob/main/script/stereoPipeline_v6.1.0.sh) to run the whole workflow.
