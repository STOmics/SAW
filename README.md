...
For SAW_v4, please use the [stereoRun_singleLane_v4.1.0.sh](https://github.com/STOmics/SAW/blob/main/Scripts/stereoRun_singleLane_v4.1.0.sh) or [stereoRun_multiLane_v4.1.0.sh](https://github.com/BGIResearch/SAW/blob/main/script/stereoRun_multiLane_v4.0.0.sh) to run the whole workflow.
